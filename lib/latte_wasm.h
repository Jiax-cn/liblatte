#ifndef LIB_LATTE_WASM_H_
#define LIB_LATTE_WASM_H_
...
uint8_t *encode_portid_section(uint8_t *data, uint32_t data_length,
                               uint32_t *ret_section_length);

void parse_portid_section(uint8_t *wasm_buf, uint32_t wasm_size,
